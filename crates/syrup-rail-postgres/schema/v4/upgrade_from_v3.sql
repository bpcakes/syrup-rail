-- Forward-only Syrup Rail schema upgrade from version 3 to version 4.
--
-- Apply these bytes once inside a host-owned transaction while all schema-v3
...
-- preflight_from_v3.sql. The transaction aborts when a tuple cannot be
