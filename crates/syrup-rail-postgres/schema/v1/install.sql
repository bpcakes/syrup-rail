-- Syrup Rail canonical PostgreSQL schema, version 1.
--
...
ON public.billing_subscriptions (next_renewal_at, gateway_account_id, id)
WHERE status IN ('active', 'past_due');
    ...
    CONSTRAINT billing_subscription_discounts_duration_periods_check
        CHECK (
            ...
            OR (
                ...
                AND periods_applied BETWEEN 1 AND periods_total
                AND (
                    (
