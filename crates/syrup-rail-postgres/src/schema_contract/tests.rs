...
use super::{
    ...
    V3_CATALOG_FINGERPRINT, V3_INSTALL_SQL, V3_TO_V4_INCOMPATIBLE_ATTESTATION_AUDIT_SQL,
    V3_TO_V4_PREFLIGHT_SQL, V3_TO_V4_UPGRADE_SQL, V4_CATALOG_FINGERPRINT, V4_INSTALL_SQL,
    active_reindex_shadows, assert_schema_conforms, assert_v1_conforms, assert_v2_conforms,
    assert_v3_conforms, assert_v4_conforms,
